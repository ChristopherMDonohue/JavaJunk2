...
public class A2 {
    ...
    /** E: Protect the letters in 'a'..'z' by surrounding them with the corresponding capital
     * letters. That is: Return a copy of string s but with all letters in 'a'..'z' surrounded by
     * the corresponding upper-case letter. <br>
     * Examples: <br>
     * For s = "", return "". <br>
        ...
        if (s.length() == 0) {
            ...
            for (int i= 0; i < s.length(); i++ ) {
                if (s.charAt(i) <= 'z' && s.charAt(i) >= 'a') {
                    char capital= (char) (s.charAt(i) + diff);
     ...
     * Examples:<br>
     * putLittlesFirst("aAbBcCdDxXy$zZ") = "abcsxyzABCDX$Z" <br>
     * putLittlesFirst("mnopqrst") = "mnopqrst" <br>
     * putLittlesFirst("1z$aàēĤƀ") = "1a$bàēĤƀ" */
